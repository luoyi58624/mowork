		...
		<view class="p-2">
			<view class="relative px-2 py-3 flex items-center rounded-md bg-white m-elevation-1">
				...
				<view class="absolute bottom-2 right-2 m-scale-85" @click="skipAuditPage(data)">
					<uni-tag v-if="data.isComplete == 1" text="已完结" size="small" type="success" inverted></uni-tag>
					<uni-tag v-else-if="data.state == 0" text="已驳回" size="small" type="error" inverted></uni-tag>
					<uni-tag v-else-if="data.state == 1" text="进行中" size="small" type="primary" inverted></uni-tag>
					<uni-tag v-else-if="data.state == 2" text="待审核" size="small" type="default" inverted></uni-tag>
					<uni-tag v-else-if="data.state == 3" text="待批准" size="small" type="default" inverted></uni-tag>
					<uni-tag v-else-if="data.state == 4" text="制定中" size="small" type="default" inverted></uni-tag>
					<uni-tag v-else-if="data.state == 5" text="已暂停" size="small" type="default" inverted></uni-tag>
					<uni-tag v-else-if="data.state == 6" text="已完结" size="small" type="success" inverted></uni-tag>
					<uni-tag v-else-if="data.state == 8" text="已关闭" size="small" type="warning" inverted></uni-tag>
					<uni-tag v-else-if="data.state == 9" text="待复核" size="small" type="default" inverted></uni-tag>
				</view>
			</view>
